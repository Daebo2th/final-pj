    ...
    <section class="section profile">
        <div class="row">
            <div class="col-xl-5">
                ...
                <div class="card">
                    <div
                            class="card-body profile-card pt-5 d-flex flex-column align-items-center"
                            style="height: 446px;">
                    ...
                    <div class="card-body pt-3">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link active" data-bs-toggle="tab"
                                        data-bs-target="#profile-overview">개요
                                </button>
                            </li>

                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab"
                                        data-bs-target="#profile-edit">프로필 편집
                                </button>
                            </li>

                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab"
                                        data-bs-target="#profile-change-password">패스워드 변경
                                </button>
                            </li>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview"
                                ...
                                <h5 class="card-title"
                                    style="font-family: Roboto, sans-serif; font-weight: 700; line-height: 1.5; margin-bottom: 0; padding: 15px 0px; font-size: 22px; color: #012970;">
                                    상세 정보</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8"><fmt:formatDate value="${mypage.birthday}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8"><fmt:formatDate value="${mypage.regDate}"
                                                                                   pattern="yyyy / MM / dd"></fmt:formatDate></div>
                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="country" type="text" class="form-control"
                                                   id="Country" value="${mypage.gender=='M'?'남자':'여자'}"
                                                   readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="address" type="text" class="form-control"
                                                   id="job"
                                                   value="<fmt:formatDate value="${mypage.birthday}" pattern="yyyy / MM / dd"></fmt:formatDate>"
                                                   readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="email" type="email" class="form-control"
                                                   id="Email"
                                                   value="<fmt:formatDate value="${mypage.regDate}" pattern="yyyy / MM / dd"></fmt:formatDate>"
                                                   readonly="readonly">
                                        </div>
                                    </div>
                                ...
                                <form action="/changePw" method="POST" name="myPage-form"
                                    ...
                                    <div class="row mb-3">
                                        <label for="currentPassword"
                                               ...
                                               style="color: rgba(1, 41, 112, 0.6); font-weight: bold;">현재 패스워드</label>
                                        <div class="col-md-8 col-lg-9">
                                    ...
                                    <div class="row mb-3">
                                        <label for="newPassword"
                                               class="col-md-4 col-lg-3 col-form-label"
                                               style="color: rgba(1, 41, 112, 0.6); font-weight: bold;">새로운 패스워드</label>
                                        <div class="col-md-8 col-lg-9">
                                    ...
                                    <div class="row mb-3">
                                        <label for="renewPassword"
                                               class="col-md-4 col-lg-3 col-form-label"
                                               style="color: rgba(1, 41, 112, 0.6); font-weight: bold;">패스워드 재입력</label>
                                        <div class="col-md-8 col-lg-9">
