...
<div class="boards">
    ...
    <div class="board">
        ...
        <button type="button" class="btn btn-outline-success" data-toggle="modal"
                data-target="#insertModal" data-zone="1">추가
        </button>
    ...
    <div class="board">
        ...
        <!-- Button trigger modal -->
        <button type="button" class="btn btn-outline-success" data-toggle="modal"
                data-target="#insertModal" data-zone="2">추가
        </button>
    ...
    <div class="board">
        ...
        <!-- Button trigger modal -->
        <button type="button" class="btn btn-outline-success" data-toggle="modal"
                data-target="#insertModal" data-zone="3">추가
        </button>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-outline-secondary" type="button"
                                    id="button-addon3" onclick="insertData()">Button
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-outline-secondary" type="button"
                                    id="button-addon2" onclick="updateDate()">Button
                            </button>
                        </div>
                    </div>
                </div>
