<%@ page import="com.fasterxml.jackson.databind.ObjectMapper" %><%-- Created by IntelliJ IDEA. User: KOSA Date:
        2023-09-06 Time: 오전 10:30 To change this template use File | Settings | File Templates. --%>
...
<head>
    ...
    <!-- fullcalendar CDN -->
    <link href='https://cdn.jsdelivr.net/npm/fullcalendar@5.8.0/main.min.css'
          rel='stylesheet'/>
    <script
                    ...
                    <div class="page-title">
                        <div class="container">
                            <div id="cardTitleflex">
                                <h4 class="card-title">${taskVO.title}
                                </h4>
                            </div>
                            <%--<h3>${taskVO.title}</h3>--%>
                        </div>
            ...
            <div class="comments-section">
                <div class="comment-post">
                    <div class="comment-details">
                        <div id="replyList">
                            <p><span class="comment-author">Rajesh
                                                                                    Gupta</span></p>
                            <p class="comment-content">Maecenas eu
                                maximus tellus, Suspendisse tincidunt
                                hendrerit nisi, sit amet aliquet enim
                                ornare at.</p>
                        </div>
                    </div>
                </div>
                <div class="comment-add">
                    <div class="field-comment">
                                                                        <textarea id="replyContent" rows="4"
                                                                                  cols="50"></textarea>
                        <div id="replyConfirmBtn"
                             style="display: flex; justify-content: flex-end">
                            <input id='replyConfirm' type='button'
        ...
        $(function () {
            $('#replyConfirm').click(function () {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        swal({
                            text: "댓글 등록이 완료 되었습니다.", buttons: "확인", closeOnClickOutside: false
                        }).then(function () {
                            //화면 초기화
