                          ...
                          <tbody>
                            <c:forEach items="${taskUserList}" var="taskUserList">
                              <tr>
                                ...
                                <td><a
                                    href="/teacher/daily-task-detail?taskSeq=${taskUserList.taskSeq}">${taskUserList.title}
                                </td>
                                <td>
                                  <fmt:formatDate value="${taskUserList.updateDate}" pattern="yyyy-MM-dd" />
                                </td>
                                <input type="hidden" name="taskSeq" value="${taskUserList.taskSeq}" />
                                <td><input type="checkbox" value="${taskUserList.status}" ${taskUserList.status=='1'
                                    ? 'checked' :''} /></td>
                              </tr>
                            </c:forEach>
                          </tbody>
                  ...
                  <nav aria-label="Page navigation example">
                    <ul class="pagination">
                      <c:if test="${pagingVO.nowPage > 1}">
                        <li class="page-item">
                          <a class="page-link"
                            href="?nowPage=${pagingVO.nowPage - 1}&studentUserId=${userId}&searchCondition=${param.searchCondition}&searchKeyword=${param.searchKeyword}"
                            aria-label="Previous">
                        ...
                        <c:choose>
                          ...
                          <c:otherwise>
                            <li class='page-item'><a class='page-link'
                                href="?nowPage=${status.index}&studentUserId=${userId}&searchCondition=${param.searchCondition}&searchKeyword=${param.searchKeyword}">${status.index}</a>
                            </li>
                          </c:otherwise>
                        </c:choose>
                      </c:forEach>
