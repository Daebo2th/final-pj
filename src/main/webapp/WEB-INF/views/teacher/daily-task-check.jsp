            ...
            <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                ...
                <head>
                    ...
                    <link href="${pageContext.request.contextPath}/resources/vendor/bootstrap-icons/bootstrap-icons.css"
                        rel="stylesheet">
                    <link href="${pageContext.request.contextPath}/resources/vendor/boxicons/css/boxicons.min.css"
                        rel="stylesheet">
                    <link href="${pageContext.request.contextPath}/resources/vendor/quill/quill.snow.css"
                        rel="stylesheet">
                    <link href="${pageContext.request.contextPath}/resources/vendor/quill/quill.bubble.css"
                        rel="stylesheet">
                    <link href="${pageContext.request.contextPath}/resources/vendor/remixicon/remixicon.css"
                        rel="stylesheet">
                    <link href="${pageContext.request.contextPath}/resources/vendor/simple-datatables/style.css"
                        rel="stylesheet">
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${groupTasks}" var="groupTasks">
                                                            <tr>
                                                                ...
                                                                <td><a
                                                                        href="/teacher/daily-task-detail?taskSeq=${groupTasks.taskSeq}">${groupTasks.title}
                                                                </td>
                                                                <td>
                                                                    <fmt:formatDate value="${groupTasks.updateDate}"
                                                                        pattern="yyyy-MM-dd" />
                                                                </td>
                                                                <input type="hidden" name="taskSeq"
                                                                    value="${groupTasks.taskSeq}" />
                                                                <td><input type="checkbox" value="${groupTasks.status}"
                                                                        ${groupTasks.status=='1' ? 'checked' :''} />
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
